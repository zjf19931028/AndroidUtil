...
import static com.youdu.corp.CropViewExtensions.resolveBitmapLoader;
...
public class LoadRequest {
  ...
  /**
   * Load a {@link Bitmap} using the {@link BitmapLoader} specified by {@code loaderType}, you must
   * call {@link
   * LoadRequest#load(Object)} afterwards.
   *
