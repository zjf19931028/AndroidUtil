package com.awesomevideo.network.http;
...
public class HttpConstants {
    ...
    private static final String USER_URL = "https://bggw.jeejio.com/jeejiousergateway/usergateway/jeejiouser/user/";
...
//    public static String HOME_RECOMMAND = ROOT_URL + "/contentmarket/album/getPlaylist";
//
//    /**
//     * 课程详情接口
//     */
//    public static String COURSE_DETAIL = ROOT_URL + "/product/course_detail.php";
     ...
     * 账号登录
     */
    public static final String USER_LOGIN = USER_URL + "sso/accountLogin";
}
